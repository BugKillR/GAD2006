...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AGameGrid_Statics::NewProp_GridClass = { "GridClass", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameGrid, GridClass), Z_Construct_UClass_UClass, Z_Construct_UClass_AGameSlot_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GridClass_MetaData), NewProp_GridClass_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AGameGrid_Statics::NewProp_NumRows = { "NumRows", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameGrid, NumRows), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NumRows_MetaData), NewProp_NumRows_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AGameGrid_Statics::NewProp_NumCols = { "NumCols", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameGrid, NumCols), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NumCols_MetaData), NewProp_NumCols_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AGameGrid_Statics::NewProp_GridActors = { "GridActors", nullptr, (EPropertyFlags)0x001000800002001d, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameGrid, GridActors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GridActors_MetaData), NewProp_GridActors_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameGrid_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGameGrid, AGameGrid::StaticClass, TEXT("AGameGrid"), &Z_Registration_Info_UClass_AGameGrid, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameGrid), 3034913763U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameGrid_h_2727559479(TEXT("/Script/Labwork2"),
	Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameGrid_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameGrid_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
