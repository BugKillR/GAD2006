...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_AGameSlot_SetState_Statics::NewProp_NewState = { "NewState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GameSlot_eventSetState_Parms, NewState), Z_Construct_UEnum_Labwork2_EGridState, METADATA_PARAMS(0, nullptr) }; // 2233810893
...
struct Z_Construct_UClass_AGameSlot_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OffensiveMaterial_MetaData[] = {
		{ "ModuleRelativePath", "Private/GameSlot.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SupportiveMaterial_MetaData[] = {
		{ "ModuleRelativePath", "Private/GameSlot.h" },
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_OffensiveMaterial;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_SupportiveMaterial;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AGameSlot_OnGridClicked, "OnGridClicked" }, // 3563988097
		{ &Z_Construct_UFunction_AGameSlot_SetState, "SetState" }, // 242430958
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGameSlot_Statics::NewProp_Box = { "Box", nullptr, (EPropertyFlags)0x001000000008001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameSlot, Box), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Box_MetaData), NewProp_Box_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGameSlot_Statics::NewProp_Plane = { "Plane", nullptr, (EPropertyFlags)0x001000000008001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameSlot, Plane), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Plane_MetaData), NewProp_Plane_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGameSlot_Statics::NewProp_DefaultMaterial = { "DefaultMaterial", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameSlot, DefaultMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefaultMaterial_MetaData), NewProp_DefaultMaterial_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGameSlot_Statics::NewProp_HighlightMaterial = { "HighlightMaterial", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameSlot, HighlightMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HighlightMaterial_MetaData), NewProp_HighlightMaterial_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGameSlot_Statics::NewProp_OffensiveMaterial = { "OffensiveMaterial", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameSlot, OffensiveMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OffensiveMaterial_MetaData), NewProp_OffensiveMaterial_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGameSlot_Statics::NewProp_SupportiveMaterial = { "SupportiveMaterial", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameSlot, SupportiveMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SupportiveMaterial_MetaData), NewProp_SupportiveMaterial_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGameSlot_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGameSlot_Statics::NewProp_DefaultMaterial,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGameSlot_Statics::NewProp_HighlightMaterial,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGameSlot_Statics::NewProp_OffensiveMaterial,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGameSlot_Statics::NewProp_SupportiveMaterial,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EGridState_StaticEnum, TEXT("EGridState"), &Z_Registration_Info_UEnum_EGridState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2233810893U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSGridPosition::StaticStruct, Z_Construct_UScriptStruct_FSGridPosition_Statics::NewStructOps, TEXT("SGridPosition"), &Z_Registration_Info_UScriptStruct_SGridPosition, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSGridPosition), 3677357517U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGameSlot, AGameSlot::StaticClass, TEXT("AGameSlot"), &Z_Registration_Info_UClass_AGameSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameSlot), 1649261624U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_3339175119(TEXT("/Script/Labwork2"),
	Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_IntroductionToUE_GAD2006_HW3_CommandBasedGame_Source_Labwork2_Private_GameSlot_h_Statics::EnumInfo));
// End Registration
